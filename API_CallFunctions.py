...
Best regards, Amine Sakoute | Organizer @Daydream Casablanca 2025.""".format(fullname=fullname)}
        ...
        html_bodies={'NOT_SIGNED':"""
             ...
             <body>
            <div id="main_div" style="text-align:center;background:radial-gradient(circle at top left,#c0e5fb 0%,#fbecc6 70%,#e79ec4 90%) top left,radial-gradient(circle at top right,#c0e5fb 0%,#fbecc6 70%,#e79ec4 90%) top right,radial-gradient(circle at bottom left,#c0e5fb 0%,#fbecc6 70%,#e79ec4 90%) bottom left,radial-gradient(circle at bottom right,#c0e5fb 0%,#fbecc6 70%,#e79ec4 90%) bottom right;background-size:50% 50%;background-repeat:no-repeat;color:black;font-family:'Helvetica',sans-serif;font-size:13px;border-radius:5px;margin:0;width:100vw;min-height: calc(100% + 50px);">
             <h1>Hi there {fullname} !</h1>
             <pre>Hope you're doing great. 
