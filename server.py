...
{% if info %}
<div id="info_div" style="position:absolute; top:15%; left:50%; transform:translate(-50%, 0%); width:auto; height:calc(100% + 20px); background-color:white; border-radius:5px;">
<p>Id : {{ info['Id'] }}</p>
