...
{% if info %}
<div id="info_div" style="position:absolute; top:25%; left:50%; transform:translate(-50%, 0%); width:calc(100% + 20px); height:auto; background-color:white; border-radius:5px;">
<p>Id : {{ info['Id'] }}</p>
